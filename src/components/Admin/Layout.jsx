        ...
        <div className="flex flex-col">
          {
            ...
            menus.map((menu, index) => (
              <Link key={index} to={menu.path} className="text-gray-50 text-[17.5px] p-4 hover:bg-rose-600 hover:text-white"
                style={{
                  background: (location.pathname === menu.path) ? "#e11d48" : "transparent", // Highlight the active menu
                }}>
                {menu.icon}
                {menu.label}
              </Link>
